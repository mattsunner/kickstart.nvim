...
-- Spacing on tabs and auto-indents
...
-- key mappings
-- Auto-close parentheses and move the cursor between them
-- Auto-close braces and parentheses immediately
vim.api.nvim_set_keymap('i', '{', '{}<Left>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '(', '()<Left>', { noremap = true, silent = true })

-- Handle <Enter> to insert a newline with indentation
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          ['<Tab>'] = cmp.mapping.confirm { select = true }, -- manually overrode to <CR> to more quickly work through suggestions
